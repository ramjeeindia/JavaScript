// 4 You are workin. for an e-commerce client, and they provide you with an array of objects containin. product names and their prices. Your task is to create a function that finds the product with the maximum amount (the highest price) and the product with the minimum amount (the lowest price) and prints them to the console.
