...
// countdown timer for an upcoming event. You need to build a function that calculates the number of days between the current date and the event's start date.
...
const calculateDays = (date) => {
  let launchDate = new Date(`${date} 10:00:00`);
